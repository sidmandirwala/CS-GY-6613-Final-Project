...
# List the databases and collections you want to process
databases_to_process = [
    {"db_name": "github_scraper", "collection_name": "repositories"},
    {"db_name": "medium_scraper", "collection_name": "articles"},
    {"db_name": "linkedin_scraper", "collection_name": "profiles"},
]
...
for db_info in databases_to_process:
    ...
    # Dynamically retrieve all repository IDs from the collection
    repo_ids = collection.distinct("_id")
